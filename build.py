...
html site. Run it from this directory by simply doing the following:
    ...
    $ python build.py SITE_DIRECTORY
...
PAGES = ['cfp', 'committee', 'index', 'accepted', 'program']


IMAGES = [os.path.join('images', 'logo', 'LAW13_Logo.svg')]
            ...
            with open(fname_out, 'w') as outfile:
                for line in infile:
                    if line.startswith('#INCLUDE# '):
                        file_to_import = os.path.join('include', line.split()[1].strip())
